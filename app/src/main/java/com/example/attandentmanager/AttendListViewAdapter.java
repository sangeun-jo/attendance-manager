...
public class AttendListViewAdapter extends BaseAdapter {
    ...
    public ArrayList<StudentInfo> listViewItemList;

    // ListViewAdapter의 생성자
    public AttendListViewAdapter(ArrayList<StudentInfo> listViewItemList){
        this.listViewItemList = listViewItemList;
    }

    public void setListViewItemList(ArrayList<StudentInfo> listViewItemList) {
        this.listViewItemList = listViewItemList;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.attand_listview, parent, false);
        }
        ...
        StudentInfo listViewItem = listViewItemList.get(position);
